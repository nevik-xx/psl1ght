...
#define CONFIG_KEYS_PATH "/usr/local/ps3dev/bin/data"
#define CONFIG_CURVES_FILE "ldr_curves"
#define CONFIG_CURVES_PATH "/usr/local/ps3dev/bin/data"
#define CONFIG_VSH_CURVES_FILE "vsh_curves"
#define CONFIG_VSH_CURVES_PATH "/usr/local/ps3dev/bin/data"
#define CONFIG_IDPS_FILE "idps"
#define CONFIG_IDPS_PATH "/usr/local/ps3dev/bin/data"
#define CONFIG_ACT_DAT_FILE "act.dat"
#define CONFIG_ACT_DAT_PATH "/usr/local/ps3dev/bin/data"
#define CONFIG_RIF_FILE_EXT ".rif"
#define CONFIG_RIF_PATH "/usr/local/ps3dev/bin/data/rifs"
#define CONFIG_RAP_FILE_EXT ".rap"
#define CONFIG_RAP_PATH "/usr/local/ps3dev/bin/data/raps"
